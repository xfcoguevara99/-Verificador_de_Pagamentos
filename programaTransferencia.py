...
doc_mercantil = pd.read_excel(archivo_del_banco + "Agosto2020.xlsx",names = ["Fechas","Descripcion","Referencia","Debito","Credito"])
...
lista_de = usuariosConReferenciasRepetidas(df_usuarios,df_mercantil)
lista_de_usuarios = []
